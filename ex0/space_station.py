...
class SpaceStation(BaseModel):
    ...
    crew_size: int = Field(ge=1, le=21)
    power_level: float = Field(ge=0.0, le=101.0)
    oxygen_level: float = Field(ge=0.0, le=101.0)
...
def main():
    ...
    try:
        inv_space_station = SpaceStation(station_id="ISS001",
                                         name="International Space Station",
                                         crew_size=99,
                                         power_level=85.5,
                                         oxygen_level=92.3,
